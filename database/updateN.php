...
if(isset($_POST["image_id"]))
{
 ...
 if($old_name != $new_name)
 {
  ...
  { 
   $query = "
   UPDATE tbl_image 
   SET image_name = '".$new_name."', image_description = '".$_POST["image_description"]."',image_link = '".$_POST["image_link"]."' 
 ...
 else
 {
  $query = "
   UPDATE tbl_image 
   SET image_description = '".$_POST["image_description"]."',image_link = '".$_POST["image_link"]."' 
   WHERE image_id = '".$_POST["image_id"]."'
   ";
 }
